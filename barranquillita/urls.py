...
urlpatterns = [
    ...
    path('explicacion/', usuarios_views.explanation_view, name='explicacion'),
    ...
    path('clientes/cancelar',
         clientes_views.cancel_bill, name='cancelarV'),
    path('clientes/pagar',
         clientes_views.pay_bill, name='pagarV'),
    path('clientes/pagarI',
         clientes_views.pay_product, name='pagarVI'),
    ...
    path('proveedores/acumulado',
         proveedores_views.see_consolidate, name='acumuladoP'),
    path('proveedores/acumulados',
         proveedores_views.see_consolidateDates, name='acumuladoFP'),
    path('proveedores/cancelar',
         proveedores_views.cancel_bill, name='cancelarP'),
    path('proveedores/pagar',
         proveedores_views.pay_bill, name='pagarP'),
    path('proveedores/pagarI',
         proveedores_views.pay_product, name='pagarPI'),
