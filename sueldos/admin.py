...
class SueldoAdmin(admin.ModelAdmin):
    list_display = ('pk', 'usuario', 'valor','nota', 'sueldo', 'modificado', 'creado')
...
class DescripcionAdmin(admin.ModelAdmin):
    list_display = ('pk', 'nombre', 'precio_vendido', 'precio_pagado', 'precio_compra', 'cantidad', 'modificado', 'creado')
    list_display_links = ('pk',)
    list_editable = ('nombre', 'precio_vendido', 'precio_pagado', 'precio_compra', 'cantidad')
    search_fields = ('nombre', 'precio_vendido', 'precio_pagado', 'precio_compra', 'cantidad')
    list_filter = ('nombre', 'precio_vendido', 'precio_pagado', 'precio_compra', 'cantidad', 'modificado', 'creado')
    fieldsets = (
        ('Descripcion', {
            'fields' : (
                ('nombre', 'cantidad'),
