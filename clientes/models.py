...
class Compra(models.Model):
    ...
    nombre = models.ForeignKey(
        'clientes.Cliente', on_delete=models.CASCADE, default=None)
    descripcion = models.ForeignKey(
        'sueldos.Descripcion', on_delete=models.CASCADE, default=None)
    cantidad = models.FloatField(blank=False)
    precio_vendido = models.FloatField(blank=False)
    nota = models.CharField(max_length=100, blank=True)
